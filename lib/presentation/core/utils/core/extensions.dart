...
extension MyString on String {
  ...
  String get trimeMobile => this.replaceAll(" ", "");
...
extension MyInt on int {
  ...
  String get setDigit =>
      NumberFormat.compactCurrency(decimalDigits: 0, symbol: "").format(this);

  String get setMonth => (this != null)
      ? this.toString() + " mois"
...
extension MyDateTime on DateTime {
  String get getAgeInYears {
    ...
    return ageInteger.toString() + " ans";
  }
}
